...
const i18n = {
    ...
    translations: {
        it: {
            ...
            tutorialStandard: 'Standard',
            tutorialThreeLives: '3 vite',
            tutorialOneLife: '1 vita',
            tutorialSamuraiMultiplier: '×1,25 punti',
            tutorialSamuraiBonus: '1 vita · ×1,25 punti',
            ...
            tutStep3: 'In modalità <b>Cancella</b> elimina solo numeri sicuramente impossibili. Con target <b>6</b>, 7 e 9 sono esclusi perché lo superano già da soli.',
            tutStep4: 'Quando una riga o colonna raggiunge il target, gli altri candidati si cancellano automaticamente.',
            tutStep5: 'Di norma hai <b>3 vite</b>. In <b>Ultimo Samurai</b> hai una sola possibilità: un errore è game over, ma il punteggio vale <b>×1,25</b>.',
        ...
        en: {
            ...
            tutorialTargetLabel: 'TARGET',
            tutorialStandard: 'Standard',
            tutorialThreeLives: '3 lives',
            tutorialOneLife: '1 life',
            tutorialSamuraiMultiplier: '×1.25 score',
            tutorialSamuraiBonus: '1 life · ×1.25 score',
            ...
            tutStep3: 'In <b>Cancel</b> mode, remove only numbers that are certainly impossible. With target <b>6</b>, 7 and 9 are excluded because each exceeds it on its own.',
            tutStep4: 'When a row or column reaches its target, the remaining candidates are removed automatically.',
            tutStep5: 'Normally you have <b>3 lives</b>. In <b>Last Samurai</b> you get one chance: one mistake is game over, but your score is worth <b>×1.25</b>.',
