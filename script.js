...
function buildTable() {
  ...
  emptyHeader.className = "grid-brand-corner game-brand-corner";
  emptyHeader.innerHTML = '<span class="brand-corner-mark" aria-hidden="true">S<span class="brand-corner-dot">.</span></span>';
